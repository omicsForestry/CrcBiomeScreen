...
output: 
  BiocStyle::html_document:
    ...
    toc_float: true
vignette: >
  %\VignetteIndexEntry{CrcBiomeScreen: Colorectal Cancer Microbiome Screening and Analysis}
...
- **Normalization methods**: Support for multiple normalization approaches including GMPR and TSS
...
The core workflow of `CrcBiomeScreen` involves several key steps: data loading and preprocessing, normalization, model training, evaluation, and validation. All functions are designed to work with the `CrcBiomeScreenObject`, which is the main data structure used throughout the package.
...
- Consider using TSS normalization instead of GMPR for very large datasets

### Poor model performance
- Check data quality and preprocessing steps
- Verify class balance in your dataset
- Consider adjusting model parameters or trying different normalization methods
- Ensure adequate sample size for training
