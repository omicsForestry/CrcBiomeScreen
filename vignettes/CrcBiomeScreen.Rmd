...
# Full-scale workflow using real cohort data for reference
...
Model training is computationally intensive (cross-validation, tuning, ensemble models) and may exceed build time limits on the Bioconductor single package builder (SPB). Therefore the vignette shows the full code but does not execute it. Users can run the complete workflow on their own machines with adequate resources.
