...
RunModeling <- function(CrcBiomeScreenObject, 
                        model_type = c("RF", "XGBoost"), 
                        n_cv = 10, 
                        task_name = "ModelingTask", 
                        TrueLabel = NULL) {
  ...
  saveRDS(CrcBiomeScreenObject, paste0("CrcBiomeScreenObject_", task_name, ".rds"))
